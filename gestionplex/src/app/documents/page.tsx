        ...
        <div className="min-h-screen">
          ...
          <div className="px-5 py-8">
            ...
            <div className="mt-4 space-y-2">
              {[
                { titre: "Bail — Linda Bouchard (1671 Hébert)", immeuble: "Triplex Laval — Hébert" },
                { titre: "Assurance — Triplex Laval 2024", immeuble: "Triplex Laval — Hébert" },
                { titre: "Taxes municipales 2024", immeuble: "Triplex Laval — Hébert" },
              ].map((doc, i) => (
                <div key={i} className="flex items-center gap-3 rounded-xl border border-gray-200/80 bg-white px-4 py-3 dark:border-gray-800 dark:bg-gray-900">
                  <div className="flex h-9 w-9 items-center justify-center rounded-lg bg-blue-50 dark:bg-blue-900/20">
                    <svg className="h-5 w-5 text-blue-600" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" /></svg>
                  </div>
                  <div className="flex-1">
                    <p className="text-sm font-medium text-gray-900 dark:text-gray-100">{doc.titre}</p>
                    <p className="text-xs text-gray-500">PDF · {doc.immeuble}</p>
                  </div>
                </div>
              ))}
            </div>
