...
export default function RevenusPage() {
  ...
  const total = revenus.reduce((sum, t) => sum + t.montant, 0);
        ...
        <div className="min-h-screen">
          ...
          <div className="space-y-5 px-5 py-5">
            ...
            <motion.div
              ...
              className="rounded-2xl border border-green-200 bg-green-50 p-5 dark:border-green-800/50 dark:bg-green-900/20"
            >
              ...
              {revenus.map((tx, i) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="flex-shrink-0 text-sm font-semibold text-green-600">
            ...
            {revenus.length === 0 && (
              <div className="flex flex-col items-center gap-3 py-12 text-center">
                ...
                <p className="text-gray-500">Aucun revenu pour ce filtre</p>
              </div>
            )}
          </div>
        </div>
